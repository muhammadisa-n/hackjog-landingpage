<template>
    <footer class="bg-gradient-to-b from-primary to-gradasi">
        <div class="mx-auto w-full p-14 ">
            ...
            <div class="flex">
                <span class="font-monserrat text-white flex-1 block text-sm sm:text-left w-3/4 pt-4 pb-4">Hackjog sebuah ekosistem Industri digital
                    yang berada di D.I.Y dalam
                    bentuk kolaborasi hexahelix.
                    Berfokus pada <br> menumbuh kembangkan industri digital serta transformasi masyarakat
            ...
            <hr>
            <div>
                <span class="block text-sm text-white sm:text-left pt-2">© 2023 - HACKJOG:DIGITAL
                    DAEMON</span>
            </div>
        </div>
    </footer>
